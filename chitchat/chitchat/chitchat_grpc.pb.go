...
type ChatServiceClient interface {
	...
	Leave(ctx context.Context, in *User, opts ...grpc.CallOption) (*Nothing, error)
	SendMessage(ctx context.Context, in *ClientMessage, opts ...grpc.CallOption) (*Nothing, error)
}
...
func (c *chatServiceClient) Leave(ctx context.Context, in *User, opts ...grpc.CallOption) (*Nothing, error) {
	out := new(Nothing)
...
func (c *chatServiceClient) SendMessage(ctx context.Context, in *ClientMessage, opts ...grpc.CallOption) (*Nothing, error) {
	out := new(Nothing)
...
type ChatServiceServer interface {
	...
	Leave(context.Context, *User) (*Nothing, error)
	SendMessage(context.Context, *ClientMessage) (*Nothing, error)
...
func (UnimplementedChatServiceServer) Leave(context.Context, *User) (*Nothing, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Leave not implemented")
}
func (UnimplementedChatServiceServer) SendMessage(context.Context, *ClientMessage) (*Nothing, error) {
